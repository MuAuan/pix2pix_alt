...
def main():
    ...
    parser.add_argument('--datasetpath0', '-d_train', type=str, default ="sugao2egaoRaw_train.hdf5")  #,  "required=True)
    parser.add_argument('--datasetpath1', '-d_test', type=str, default ="sugao2egaoRaw_test.hdf5")   #, required=True)
